...
\noindent\textbf{GitHub URL:} \url{https://github.com/Yurnero/i23-2538-NLP-Assignment}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{reports/part1_ppmi_tsne.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.72\linewidth]{reports/part1_skipgram_loss.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.48\linewidth]{reports/part2_pos_finetuned_curve.png}
    \includegraphics[width=0.48\linewidth]{reports/part2_ner_crf_curve.png}
...
\midrule
Frozen embeddings & 0.6031 & 0.0793 \\
Fine-tuned embeddings & 0.8653 & 0.3472 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\linewidth]{reports/part2_pos_confusion_matrix.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{reports/part3_transformer_curves.png}
    \caption{Transformer training and validation loss/accuracy curves.}
    \label{fig:part3_curves}
\end{figure}

Test-set classification performance was:
Transformer accuracy = 1.0000, macro-F1 = 1.0000.
The $5\times5$ confusion matrix is shown in Figure~\ref{fig:part3_cm}.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.72\linewidth]{reports/part3_topic_confusion_matrix.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.48\linewidth]{reports/part3_attention_article1_head0.png}
    \includegraphics[width=0.48\linewidth]{reports/part3_attention_article1_head1.png}
    \includegraphics[width=0.48\linewidth]{reports/part3_attention_article2_head0.png}
    \includegraphics[width=0.48\linewidth]{reports/part3_attention_article2_head1.png}
    \includegraphics[width=0.48\linewidth]{reports/part3_attention_article3_head0.png}
    \includegraphics[width=0.48\linewidth]{reports/part3_attention_article3_head1.png}
...
On the same stratified test split, the Transformer achieved 1.0000 accuracy and 1.0000 macro-F1.
The BiLSTM baseline achieved 0.9905 accuracy and 0.9905 macro-F1.
Therefore, the Transformer was higher by 0.0095 accuracy points in this run.
In terms of convergence, the Transformer reached peak validation accuracy at epoch 4.
The BiLSTM reached its best validation accuracy at epoch 5, so the Transformer converged in fewer epochs.
Average per-epoch training time was 24.45 seconds for the Transformer.
Average per-epoch training time was 21.15 seconds for the BiLSTM, which was slightly faster in wall-clock cost per epoch.
