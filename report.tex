...
Fine-tuned embeddings & 0.9459 & 0.6161 \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
PER & 1.0000 & 0.9709 & 0.9852 \\
LOC & 1.0000 & 1.0000 & 1.0000 \\
ORG & 1.0000 & 1.0000 & 1.0000 \\
MISC & 1.0000 & 1.0000 & 1.0000 \\
Overall & 1.0000 & 0.9942 & 0.9971 \\
\bottomrule
\end{tabular}
\end{table}

CRF and no-CRF overall F1 differed in this run (0.9971 with CRF vs. 0.9980 without CRF).
...
\midrule
A1 (Unidirectional LSTM) & 0.0688 & 0.0000 \\
A2 (No dropout) & 0.1857 & 0.2517 \\
A3 (Random embeddings) & 0.1726 & 0.2399 \\
A4 (Softmax instead of CRF) & -- & 0.2414 \\
\bottomrule
\end{tabular}
\end{table}
